...
use concerns::{
    ComponentPurchase, LaunchExecution, ModuleInstall, SatelliteManagement, SensorBudget,
    SensorPurchase,
};
...
/// purchase components → satellite management → execute launches.
///
