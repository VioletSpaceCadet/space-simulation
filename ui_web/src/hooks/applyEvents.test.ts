    ...
    it('updates module thermal state to Warning zone', () => {
      const station = makeStation({
        modules: [{
          ...
          kind_state: { Processor: { threshold_kg: 0, ticks_since_last_run: 0, stalled: false } },
          wear: { wear: 0 },
          thermal: { temp_mk: 2_000_000, thermal_group: 'default', overheat_zone: 'Nominal' as const, overheat_disabled: false },
        }],
      });

      const events = [{
        id: 'e1', tick: 10,
        event: { OverheatWarning: { station_id: 'station_001', module_id: 'mod_smelter', temp_mk: 2_200_000, max_temp_mk: 2_000_000 } },
      }];
    ...
    it('updates module thermal state to Critical zone and disables module', () => {
      const station = makeStation({
        modules: [{
          ...
          kind_state: { Processor: { threshold_kg: 0, ticks_since_last_run: 0, stalled: false } },
          wear: { wear: 0 },
          thermal: { temp_mk: 2_200_000, thermal_group: 'default', overheat_zone: 'Warning' as const, overheat_disabled: false },
        }],
      });

      const events = [{
        id: 'e1', tick: 10,
        event: { OverheatCritical: { station_id: 'station_001', module_id: 'mod_smelter', temp_mk: 2_500_000, max_temp_mk: 2_000_000 } },
      }];
    ...
    it('resets module thermal state to Nominal zone', () => {
      const station = makeStation({
        modules: [{
          ...
          kind_state: { Processor: { threshold_kg: 0, ticks_since_last_run: 0, stalled: false } },
          wear: { wear: 0 },
          thermal: { temp_mk: 2_500_000, thermal_group: 'default', overheat_zone: 'Critical' as const, overheat_disabled: true },
        }],
      });

      const events = [{
        id: 'e1', tick: 10,
        event: { OverheatCleared: { station_id: 'station_001', module_id: 'mod_smelter', temp_mk: 1_900_000 } },
      }];
