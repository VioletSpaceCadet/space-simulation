...
// - Inner (CopilotProvider): narrower catch around the `<CopilotSidebar>`
//   so a co-pilot crash only kills the chat, not the rest of the app.
//   The inner boundary fires first for realistic CopilotKit-side failures
//   (network, schema, sidebar chrome), leaving App panels untouched.
